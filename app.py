...
.css-1d391kg, .css-1v0mbdj, .css-1kyxreq, .css-1gkcyyc {{background-color: {bg_color} !important; color: {text_color} !important;}}
.stButton>button {{background-color: #f0f2f6; color: {text_color};}}
.stDataFrame div {{background-color: {bg_color} !important; color: {text_color} !important;}}
h1,h2,h3,h4,h5,h6,.css-1v0mbdj,.css-1kyxreq {{color: {text_color} !important;}}
</style>
